...
def config():
    ...
    # Folders
    parser.add_argument('--output_dir', metavar='DIR',default='Mammo-CLIP-output/', help='path to output logs')
...
def main(args):
    ...
    if args.train: 
        ...
        args.output_path = Path(f"{args.output_dir}/{args.label}/train/{args.training_mode}/{now}") 
